...
const file_product_product_proto_rawDesc = "" +
	...
	"\fListProducts\x12\x1c.product.ListProductsRequest\x1a\x1d.product.ListProductsResponseB\x1bZ\x19mini-shop/proto/productpbb\x06proto3"
...
var file_product_product_proto_depIdxs = []int32{
	...
	5, // 4: product.ProductService.GetProduct:output_type -> product.GetProductResponse
	6, // 5: product.ProductService.CreateProduct:output_type -> product.CreateProductResponse
